...
const CartPage = () => {
  ...
  return (
    <div className="bg-white">
      <MenuNavebar title="Shopping Cart" breadcrumbs={breadcrumbs} />
      ...
      {product.length > 0 && (
        <button 
          ...
          className='bg-yellow-600 text-white border rounded-lg px-4 py-2 hover:bg-yellow-500 transition ml-[300px] lg:ml-[700px]'
        >
          Check Out
        </button>
      )}
